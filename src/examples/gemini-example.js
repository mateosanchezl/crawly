...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const scraper = new CheerioScraper_1.CheerioScraper(url, true);
        // Create a new GeminiAdapter instance with your API key and chosen model
        const gemini = new GeminiAdapter_1.GeminiAdapter("YOUR_GOOGLE_GENERATIVE_AI_API_KEY", // Replace with your actual API key
